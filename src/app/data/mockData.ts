...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    isRemote: false,
    category: 'PartTime',
    requirements: ['알바', '고객응대', '음료 제조', '초보 가능'],
    deadline: '2026-08-23',
    posted: '2026-08-20',
    aiScore: 92,
    aiReasons: ['오늘 등록된 알바 공고입니다.', '유연근무가 가능해 일정 조정이 쉽습니다.', '매장 접근성 지원 항목이 포함되어 있습니다.'],
    description: '스타벅스 매장에서 음료 제조와 고객 응대를 담당할 바리스타 알바를 모집합니다. 초보자도 교육 후 근무할 수 있습니다.',
    benefits: ['유니폼 제공', '음료 할인', '유연근무', '교육 지원'],
    companyDesc: '스타벅스 코리아는 전국 매장을 운영하는 커피 전문 브랜드입니다.',
    headcount: 4,
    accessibility: { elevator: true, parking: false, wheelchair: true, restroom: true, guideDog: true, hearingLoop: false },
    scores: { skill: 82, workCondition: 92, accessibility: 88, location: 90 },
  },
  {
    id: '12',
    company: '올리브영',
    ...
    isRemote: false,
    category: 'PartTime',
    requirements: ['알바', '매장관리', '계산 보조', '초보 가능'],
    deadline: '2026-08-26',
    posted: '2026-08-19',
    aiScore: 88,
    aiReasons: ['주말 중심 근무라 평일 일정과 병행할 수 있습니다.', '화상 면접을 지원합니다.', '장애인 주차 편의가 제공됩니다.'],
    description: '올리브영 매장에서 상품 진열, 재고 정리, 계산 보조 업무를 담당할 알바를 모집합니다.',
    benefits: ['직원 할인', '주말 근무', '화상 면접', '초보 교육'],
    companyDesc: '올리브영은 헬스앤뷰티 매장을 운영하는 리테일 기업입니다.',
    headcount: 3,
    accessibility: { elevator: true, parking: true, wheelchair: true, restroom: true, guideDog: false, hearingLoop: false },
    scores: { skill: 78, workCondition: 86, accessibility: 90, location: 85 },
  },
  {
    id: '13',
    company: '쿠팡풀필먼트',
    ...
    isRemote: false,
    category: 'PartTime',
    requirements: ['알바', '단기근무', '포장', '검수'],
    deadline: '2026-08-22',
    posted: '2026-08-18',
    aiScore: 84,
    aiReasons: ['단기 근무가 가능한 알바 공고입니다.', '보조기기 지원 항목이 포함되어 있습니다.', '마감이 가까운 공고입니다.'],
    description: '물류센터에서 상품 포장과 검수 업무를 담당할 단기 알바를 모집합니다.',
    benefits: ['일급 지급', '식사 제공', '통근 지원', '단기 근무'],
    companyDesc: '쿠팡풀필먼트는 물류 운영과 배송 지원 서비스를 제공합니다.',
    headcount: 8,
    accessibility: { elevator: true, parking: true, wheelchair: false, restroom: true, guideDog: false, hearingLoop: false },
    scores: { skill: 72, workCondition: 80, accessibility: 82, location: 78 },
  },
  {
    id: '14',
    company: '배달의민족 B마트',
    ...
    isRemote: false,
    category: 'PartTime',
    requirements: ['알바', '재고관리', '피킹', '운영'],
    deadline: '2026-08-29',
    posted: '2026-08-17',
    aiScore: 86,
    aiReasons: ['오후 시간대 근무가 가능한 알바입니다.', '유연근무 조건이 포함되어 있습니다.', '장애인 주차 편의가 제공됩니다.'],
    description: 'B마트 물류 거점에서 상품 피킹, 검수, 재고 정리 업무를 담당할 알바를 모집합니다.',
    benefits: ['간식 제공', '유연근무', '근무복 제공', '초보 교육'],
    companyDesc: '배달의민족 B마트는 빠른 장보기 서비스를 운영합니다.',
    headcount: 5,
    accessibility: { elevator: true, parking: true, wheelchair: true, restroom: true, guideDog: false, hearingLoop: false },
    scores: { skill: 75, workCondition: 84, accessibility: 86, location: 82 },
  },
  {
    id: '15',
    company: '교보문고',
    ...
    isRemote: false,
    category: 'PartTime',
    requirements: ['알바', '고객지원', '도서 정리', '오늘 등록'],
    deadline: '2026-09-01',
    posted: '2026-08-20',
    aiScore: 90,
    aiReasons: ['오늘 등록된 알바 공고입니다.', '고객지원 직무와 맞는 공고입니다.', '화상 면접과 보조기기 지원 항목이 있습니다.'],
    description: '교보문고 매장에서 도서 정리, 고객 안내, 재고 확인을 담당할 평일 알바를 모집합니다.',
    benefits: ['도서 할인', '평일 근무', '화상 면접', '보조기기 지원'],
    companyDesc: '교보문고는 온오프라인 서점과 문화 서비스를 운영합니다.',
    headcount: 2,
    accessibility: { elevator: true, parking: false, wheelchair: true, restroom: true, guideDog: true, hearingLoop: true },
    scores: { skill: 80, workCondition: 88, accessibility: 92, location: 87 },
  },
];
...
export const categories = [
  ...
  { id: 'PartTime', label: '알바', icon: 'Briefcase', count: 58 },
];
